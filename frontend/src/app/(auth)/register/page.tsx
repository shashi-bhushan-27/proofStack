...
export default function RegisterPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#020617] px-4 py-12 text-white">
      <div className="w-full max-w-md space-y-6 rounded-2xl border border-slate-800 bg-slate-900/60 p-8 shadow-2xl backdrop-blur-xl animate-fade-in">
        <div className="text-center">
          ...
          <p className="mt-1 text-xs text-slate-400">
            Save your resume evaluations, unlock AI STAR interrogation interviews, and track your progress.
          </p>
        </div>
